...
public class KafkaConfig {
    ...
    public NewTopic paymentSuccessTopic() {
        return buildTopic(ETopics.PAYMENT_VALIDATION_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic paymentValidationFailTopic() {
        return buildTopic(ETopics.PAYMENT_VALIDATION_FAIL.getTopic());
    }

    @Bean
    public NewTopic inventoryValidationSuccessTopic() {
        return buildTopic(ETopics.INVENTORY_VALIDATION_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic inventoryValidationFailTopic() {
        return buildTopic(ETopics.INVENTORY_VALIDATION_FAIL.getTopic());
    }
